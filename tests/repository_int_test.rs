//! Integration tests for the `Repository` trait contract and `in_memory_repository()`.

use std::sync::Arc;
use async_trait::async_trait;
use edge_domain::{in_memory_repository, Repository, RepositoryError};
...
// ── in_memory_repository factory ─────────────────────────────────────────────

/// @covers: in_memory_repository
#[tokio::test]
async fn test_in_memory_repository_save_and_find_round_trips_entity() {
    let repo: Arc<dyn Repository<String, u64>> = in_memory_repository();
...
/// @covers: in_memory_repository
#[tokio::test]
async fn test_in_memory_repository_find_returns_none_for_missing_id() {
    let repo: Arc<dyn Repository<String, u64>> = in_memory_repository();
...
/// @covers: in_memory_repository
#[tokio::test]
async fn test_in_memory_repository_delete_removes_entity() {
    let repo: Arc<dyn Repository<String, u64>> = in_memory_repository();
...
/// @covers: in_memory_repository
#[tokio::test]
async fn test_in_memory_repository_list_returns_all_saved_entities() {
    let repo: Arc<dyn Repository<String, u64>> = in_memory_repository();
