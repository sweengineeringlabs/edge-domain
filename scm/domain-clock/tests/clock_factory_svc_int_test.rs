//! SAF facade tests — `ClockFactory` constructors.
#![allow(clippy::unwrap_used, clippy::expect_used)]

use std::time::{Duration, SystemTime};

use edge_domain_clock::{Clock, ClockFactory};

struct TestClocks;
impl ClockFactory for TestClocks {}

/// @covers: ClockFactory::system — returns a usable wall clock
#[test]
...
/// @covers: ClockFactory::system — does not return a past-stuck clock
#[test]
...
/// @covers: ClockFactory::system — zero-sized marker
#[test]
...
/// @covers: ClockFactory::fixed — reports the pinned time
#[test]
...
/// @covers: ClockFactory::fixed — does not advance between calls
#[test]
...
/// @covers: ClockFactory::fixed — anchors at UNIX_EPOCH
#[test]
