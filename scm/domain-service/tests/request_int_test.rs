//! Integration tests — `edge_application_service::Request` resolves to the shared
//! `edge_application_base::Request` contract `Service::Request` is bound against.

use edge_application_base::Request as BaseRequest;
use edge_application_service::Request;
