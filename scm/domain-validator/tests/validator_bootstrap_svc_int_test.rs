...
use edge_domain_validator::{BootstrapNameRequest, StdValidatorFactory, ValidatorBootstrap};
...
fn test_bootstrap_name_is_idempotent_error() {
    ...
    assert_eq!(name1, "validator", "bootstrap_name must return expected identifier");
}
