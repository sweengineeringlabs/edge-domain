...
use crate::api::reasoning::types::{
    LinearReasoning, PatternMetadataBuilder, ReasoningBootstrapNameRequest,
    ReasoningBootstrapNameResponse, ReasoningChainBuilder, ReasoningPattern, ReasoningStepBuilder,
    StdReasoningFactory, StepResultBuilder, ThinkingProcessBuilder,
};
...
pub trait ReasoningBootstrap {
    ...
    fn bootstrap_name(
        &self,
        _req: ReasoningBootstrapNameRequest,
    ) -> Result<ReasoningBootstrapNameResponse, ReasoningError> {
        Ok(ReasoningBootstrapNameResponse {
