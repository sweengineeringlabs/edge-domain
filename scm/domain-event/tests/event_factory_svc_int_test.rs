...
use edge_domain_event::{
    AggregateApplyRequest, AggregateIdentityRequest, DomainEvent, EventAggregateIdRequest,
    EventBootstrap, EventBusConfig, EventSource, EventSourceRecvNextRequest, EventTypeRequest,
};
...
fn test_in_process_bus_publish_subscribe_round_trip_error() {
    use std::sync::Arc;
    use edge_domain_event::{EventBus, EventBusPublishRequest, EventBusSubscribeRequest};
