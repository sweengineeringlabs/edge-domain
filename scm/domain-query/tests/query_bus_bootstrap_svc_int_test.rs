//! Rule-222 coverage for [`QueryBusBootstrap`] trait fn `bootstrap_name`.
#![allow(clippy::unwrap_used, clippy::expect_used)]

use edge_domain_query::{QueryBusBootstrap, StdQueryBusFactory};
...
fn test_bootstrap_name_is_callable_via_trait_object_edge() {
    let f: &dyn QueryBusBootstrap = &StdQueryBusFactory;
