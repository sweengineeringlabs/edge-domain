//! Integration tests for the `DomainBootstrap` SAF facade.

use edge_domain::{Domain, DomainBootstrap, NoopDomainExtension, OutboundRegistry};

struct TestDomain;
impl DomainBootstrap for TestDomain {}

// --- DomainBootstrap::domain ---
...
/// @covers DomainBootstrap::outbound_registry — happy path: empty registry has len 0
#[test]
...
/// @covers DomainBootstrap::outbound_registry — error: unknown key returns None
#[test]
...
/// @covers DomainBootstrap::outbound_registry — edge: can register and retrieve a handle
#[test]
