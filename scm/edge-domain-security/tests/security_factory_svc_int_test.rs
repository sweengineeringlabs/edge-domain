//! Integration tests — `SecurityFactory` SAF facade.
...
use edge_domain_security::{
    ...
    SecurityError, SecurityFactory, SecurityServices,
};

struct TestSecurity;
impl SecurityFactory for TestSecurity {}

/// @covers: SecurityFactory::unauthenticated — returns unauthenticated context
#[test]
...
/// @covers: SecurityFactory::authenticated — sets authenticated flag
#[test]
...
/// @covers: SecurityFactory::unauthenticated — principal is None
#[test]
...
/// @covers: SecurityFactory::authenticated — principal id is preserved
#[test]
...
/// @covers: SecurityFactory::authenticated — claims are empty by default
#[test]
...
/// @covers: SecurityFactory::from_claims — non-empty map succeeds
#[test]
...
/// @covers: SecurityFactory::from_claims — empty map returns MissingClaims
#[test]
...
/// @covers: SecurityFactory::from_claims — multiple claims all stored
#[test]
...
/// @covers: SecurityFactory::noop_guard — returns NoopSecurity
#[test]
...
/// @covers: SecurityFactory::noop_guard — is zero-sized
#[test]
fn test_noop_guard_is_zero_sized_error() {
    assert_eq!(std::mem::size_of_val(&TestSecurity::noop_guard()), 0);
}

/// @covers: SecurityFactory::noop_guard — successive calls are independent
#[test]
...
/// @covers: SecurityServices — factory methods match TestSecurity factory methods
#[test]
...
/// @covers: SecurityFactory::context_builder — returns a usable builder
#[test]
...
/// @covers: SecurityFactory::context_builder — builder starts with empty claims
#[test]
...
/// @covers: SecurityFactory::context_builder — successive calls are independent
#[test]
...
/// @covers: SecurityContextBuilder — type is accessible from factory
#[test]
fn test_security_context_builder_type_accessible_error() {
    let _ = SecurityContextBuilder::new();
}

/// @covers: SecurityContextBuilder — default factory and new() produce equal initial state
#[test]
