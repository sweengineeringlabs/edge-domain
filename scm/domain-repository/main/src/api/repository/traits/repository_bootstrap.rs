//! `RepositoryBootstrap` — SAF bootstrap trait for constructing repository instances.

use std::hash::Hash;

use crate::api::repository::types::InMemoryRepository;

/// Bootstrap for constructing repository instances.
///
/// Implement this trait on a unit struct to gain access to the factory methods.
pub trait RepositoryBootstrap {
