//! Integration tests — `edge_application_service::Response` resolves to the shared
//! `edge_application_base::Response` contract `Service::Response` is bound against.

use edge_application_base::Response as BaseResponse;
use edge_application_service::Response;
